...
struct OnboardingFinalNotes: View {
    ...
    var body: some View {
        VStack(alignment: .leading) {
            ...
            HowItWorksCard(systemImage: "bell.fill", title: "Audio Playback", content: "As soon as you join a group, the audio from that group starts playing. Don't be startled, it's okay!").padding(.vertical, 5)
            Button {
